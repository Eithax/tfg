...
\keywords{SDN\and enrutamiento consciente de carbono}
...
Y por último, aunque no menos importante, darle las gracias a mi amigo Rubén Serrano Izquierdo por las píldoras de información y los datos curiosos sobre redes y temas de \textit{backend}. Fue quien abrió la puerta a mi interés por las redes y a plantearme un TFG relacionado con este tema.
...
\noindent\textbf{Keywords}: SDN, carbon-aware routing.
