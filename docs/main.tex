...
En este trabajo se propone una solución basada en redes definidas por software y algoritmos bioinspirados para optimizar las emisiones de $CO_2$ asociadas al uso de las redes de comunicaciones. Más concretamente, se hace uso de la investigación realizada en \cite{ElZahr2023}, que proporciona una fórmula para calcular las emisiones de $CO_2$ en función del tráfico de datos y el consumo energético. Con esta fórmula en mente, se ha modelado una función de optimización que se usará en un algoritmo de optimización por enjambre de partículas (PSO, por sus siglas en inglés) para encontrar la configuración de red que minimice las emisiones de $CO_2$. Se han usado diferentes topologías de red y matrices de tráfico para evaluar la viabilidad del algoritmo en diferentes escenarios.

Se presentan dos versiones diferentes del algoritmo, así como diferentes maneras de realizar el enrutado
