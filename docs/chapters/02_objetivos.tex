...
El principal objetivo de este trabajo es proponer una solución que permita reducir las emisiones de $CO_2$ en redes cableadas provinientes del consumo energético de los dispositivos de red. Mediante el diseño de dos algoritmos, uno encargado del enrutamiento consciente de carbono y el otro del apagado eficiente de enlaces, se modifica la configuración de la red para que el consumo energético de sus dispositivos se centre en zonas de bajas emisiones y, por tanto, se reduzca la huella de carbono asociada a la infraestructura. Para ello, se han definido los siguientes objetivos específicos:
...
\begin{itemize}
    \item Propuesta de un algoritmo de encaminamiento verde. Se ha diseñado e implementado un algoritmo de PSO adaptado a espacios de búsqueda discretos, integrando tanto el enrutamiento consciente de carbono como el apagado eficiente de enlaces.
